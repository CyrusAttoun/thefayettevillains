        ...
        <Group justify="space-between" style={{ marginTop: 10 }}>
          ...
          <Group gap={8}>
            <Tooltip label="Upvotes" withArrow>
              <ActionIcon variant="subtle" color="red" style={{ background: 'rgba(0,0,0,0.25)' }}>
            ...
            <Tooltip label="Comments" withArrow>
              <ActionIcon variant="subtle" color="gray" style={{ background: 'rgba(0,0,0,0.25)' }}>
